 ...
 * @author 0xS7AN
 *
 * The system is designed to be as minimal as possible and have the tokens maintain 1:1 peg
 *
 * This stablecoin has these properties:
 ...
 *
 * Our DSC system should always be "overcollateralized". At no point should the value of all collateral be less than the dollar backed value of all the DSC
 *
...
contract DSCEngine is ReentrancyGuard {
     ...
     * @notice A known bug would be if the protocol were a 100% or less collateralized, then we would not be able to incentivize the liquidators
     */
    ...
    /**
     * @dev Low-level internal function, do not call it unless the function calling it is checking for health factor being broken
     */
